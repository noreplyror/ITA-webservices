...
module Webservices
  class Application < Rails::Application
    ...
    config.cache_store = :redis_store, {host: 'localhost', port: 6379, db: 0, namespace: 'ita'} # "redis://localhost:6379/0/cache", { expires_in: 90.minutes }
    ...
    config.endpointme_url = 'http://localhost:3002' #'http://api.trade.gov' #'http://localhost:3000'
